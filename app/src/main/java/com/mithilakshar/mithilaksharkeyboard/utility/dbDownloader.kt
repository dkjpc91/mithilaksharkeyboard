...
import com.mithilakshar.mithilaksharkeyboard.HomeActivity
import com.mithilakshar.mithilaksharkeyboard.MainActivity
import com.mithilakshar.mithilaksharkeyboard.Room.Updates
...
class dbDownloader(
    ...
    fun observeFileExistence(
        ...
        var fileExistenceLiveData = checkFileExistence("$filename.db",mainActivity)
    ...
    fun checkFileExistence(fileName: String, mainActivity: MainActivity): LiveData<Boolean> {
        val fileExistsLiveData = MutableLiveData<Boolean>()
        val dbFolderPath = mainActivity.getExternalFilesDir(null)?.absolutePath + File.separator + "test"
